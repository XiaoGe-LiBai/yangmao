 ...
 *
 * 
 * 提示功能: 一机跑多号容易黑，建议跑单号，如果开不了宝箱或溜走挂个一两天就恢复正常。
 * 广告功能: 一个号一天最多只能看298个广告视频自行定义运行时间和看广告数量
 * 更新内容：优化看广告速度、增加进长奖励领取、增加观看小视频时长。
 * 
...
let numamount = '20';         //金币低于不反复任务
//===============脚本版本=================//
let scriptVersion = "v2.2";
let update_tines = "2023-08-28";
let update_data = "2023-12-12";   //测试时间
let scriptVersionLatest = "v2.2"; //版本对比
...
// ============================================执行项目============================================ \\
            ...
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                        ...
                        let result = JSON.parse(data);
                        if (result.err_no == 0) {
                            DoubleLog(`\n ✅ 【${this.index}】签到信息: 获得 ${result.data.amount} 金币`)
                        } else {
                            DoubleLog(`\n ❌ 【${this.index}】签到信息: ${result.err_tips}`)
                        }
                    }
    ...
    async signin_video(timeout = 2000) {
        return new Promise((resolve) => {
            ...
            let url = {
                ...
                body: `ad_fallback=false&enter_from=goldcoin_pendant&income_id=1009606_109521973635_1692850419615&reward_stage=2&ad_seconds=25000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
    ...
    async signin_video_stop(timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                ...
                body: `ad_fallback=false&reward_stage=2&income_id=1009606_109521973635_1692850419615`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
    ...
    async doneeat_video(timeout = 2000) {
        return new Promise((resolve) => {
            ...
            let url = {
                ...
                body: `ad_fallback=false&enter_from=goldcoin_pendant&income_id=1009606_109521973635_1692850419615&time_conf_id=1&creator_id=1009606000&reward_stage=2&ad_seconds=25000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
    ...
    async doneeat_video_stop(timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                ...
                body: `ad_fallback=false&reward_stage=2&income_id=1009606_109521973635_1692850419615&enter_from=goldcoin_pendant&time_conf_id=0&creator_id=1009606000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                        ...
                        let result = JSON.parse(data);
                        if (result.err_no == 0) {
                            if (numamount > result.data.amount) {
                                DoubleLog(`\n ✅ 【${this.index}】吃饭视频: 获得奖励 ${result.data.amount} 金币`);
                                this.doneeatstop = true;
                            } else {
                                DoubleLog(`\n ✅ 【${this.index}】吃饭视频: 获得奖励 ${result.data.amount} 金币`);
                            }
                        } else if (result.err_no == 10006) {
    ...
    async treasure_video(timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                ...
                body: `ad_fallback=false&enter_from=goldcoin_pendant&income_id=1009606_109521973635_1692850419615&creator_id=1009606000&reward_stage=2&ad_seconds=25000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
    ...
    async treasure_video_status(timeout = 2000) {
        return new Promise((resolve) => {
            ...
            let url = {
                ...
                body: `ad_fallback=false&reward_stage=2&income_id=1009606_109521973635_1692850419615&enter_from=goldcoin_pendant&creator_id=1009606000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
    ...
    async doublevideo(timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                ...
                body: `ad_fallback=false&enter_from=my_view_cash&income_id=1009606_109521973635_1692850419615&creator_id=1009606000&ad_seconds=25`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                ...
                try {
                    if (error) {
                        ...
                        if (result.err_no == 0) {
                            ...
                            DoubleLog(`\n ❌ 【${this.index}】视频统计: ${result.err_tips}`)
                        }
                    }
                } catch (e) {
                    $.logErr(e, response);
                    ...
                    if (error) {
                        ...
                        if (result.err_no == 0) {
                            if(result.data.task_list && Array.isArray(result.data.task_list)) {
                                for(let i=0; i < result.data.task_list.length; i++) {
                                    let taskItem = result.data.task_list[i];
                                    if (taskItem.task_id == "14007") {
                                        let statusextra = JSON.parse(taskItem.status_extra);
                                        if (taskItem.is_completed == true) {
                                            DoubleLog(`\n ❌ 【${this.index}】时长奖励: 已全部领取完毕，请明天再来。`)
                                        } else {
                                            for(let i=0; i < statusextra.status_list.length; i++) {
                                                let tasklist = statusextra.status_list[i];
                                                if (this.rainstop == true) {
                                                    break;
                                                }  else if (tasklist.has_complete == false) {
                                                    await this.result_rain(tasklist.task_id,2 * 1000);
                                                }
                                            }
                                        }
                                    }
                            ...
                            DoubleLog(`\n ❌ 【${this.index}】时长奖励: ${result.err_tips}`)
                        }
                    }
                } catch (e) {
                    $.logErr(e, response);
    ...
    async result_rain(taskid,timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                url: `${hostname}/luckycat/xigua/v1/task/done/daily_watch_v2?${this.ck[0]}&task_id=${taskid}`,
                headers: {
                    Host: host,
                    'Connection': 'Keep-Alive',
                    'Content-Type': 'application/x-www-form-urlencoded',
                    'passport-sdk-version': '40690',
                    'Cookie': this.ck[1],
                    'x-argus': this.ck[2],
                    'x-ladon': this.ck[3],
                    'User-Agent': this.ck[4],
            ...
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                        ...
                        let result = JSON.parse(data);
                        if (result.err_no == 0) {
                            DoubleLog(`\n ✅ 【${this.index}】时长奖励: 获得奖励 ${result.data.amount} 金币`);
                            await $.wait(1000);
                            await this.result_rain_video(2 * 1000);
                            await $.wait(20000);
                        } else {
                            this.rainstop  = true;
                            DoubleLog(`\n ❌ 【${this.index}】时长奖励: ${result.err_tips}`)
    ...
    async result_rain_video(timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                url: `${hostname}/luckycat/xigua/v1/task/done/daily_watch_ad?${this.ck[0]}`,
                headers: {
                    Host: host,
                    'Connection': 'Keep-Alive',
                    "Content-Type": 'application/x-www-form-urlencoded; charset=UTF-8',
                ...
                body: `ad_fallback=false&enter_from=goldcoin_pendant&income_id=1009623_109521973635_1693015311271&reward_stage=2&ad_seconds=25000`,
            }
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                        ...
                        let result = JSON.parse(data);
                        if (result.err_no == 0) {
                            DoubleLog(`\n ✅ 【${this.index}】时长广告: 获得奖励 ${result.data.amount} 金币`);
                        } else {
                            DoubleLog(`\n ❌ 【${this.index}】时长广告: ${result.err_tips}`)
                        }
                    }
                } catch (e) {
                    $.logErr(e, response);
                    ...
                    if (error) {
                        ...
                        if (result.err_no == 0) {
                            ...
                            for (let i = 1; i < numvodie; i++) {
                                await $.wait(30000);
                                if (this.resultstop == true) {
                                    DoubleLog(`\n ❌ 【${this.index}】观看视频: 金币低于设置或无金币跳出操作`);
                                    break;
                                } else {
                                    await this.open_resultvideo_stop(i,2 * 1000);
                                }
                            }
                        } else {
                            DoubleLog(`\n ❌ 【${this.index}】观看视频: ${result.err_tips}`);
    ...
    async open_resultvideo_stop(num,timeout = 2000) {
        return new Promise((resolve) => {
            let url = {
                url: `${hostname}/luckycat/xigua/v1/timer/tick?${this.ck[0]}`,
                headers: {
            ...
            $.post(url, async (error, response, data) => {
                try {
                    if (error) {
                        ...
                        let result = JSON.parse(data);
                        if (result.err_no == 0) {
                            if (numamount >= result.data.daily_watch_result.amount) {
                                DoubleLog(`\n ✅ 【${this.index}】视频奖励: 观看第 ${num} 次，获得奖励 ${result.data.daily_watch_result.amount} 金币`);
                                this.resultstop = true;
                            } else {
                                DoubleLog(`\n ✅ 【${this.index}】视频奖励: 观看第 ${num} 次，获得奖励 ${result.data.daily_watch_result.amount} 金币`);
                            }
                        } else if (result.err_no == 10006) {
                            DoubleLog(`\n ❌ 【${this.index}】视频奖励: 每天看广告赚金币已达上限`);
                            this.resultstop = true;
                        } else if (result.err_no == 10007) {
                            DoubleLog(`\n ❌ 【${this.index}】视频奖励: 该账号没有可执行任务，可能是新号`);
                            this.resultstop = true;
                        } else {
                            DoubleLog(`\n ❌ 【${this.index}】视频奖励: ${result.err_tips}`);
                            this.resultstop = true;
                        }
                    }
                } catch (e) {
